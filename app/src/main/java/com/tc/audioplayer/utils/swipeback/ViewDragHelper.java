...
package com.tc.audioplayer.utils.swipeback;
...
public class ViewDragHelper {
    ...
    /**
     * Factory method to initAndGet a new ViewDragHelper.
     *
    ...
    /**
     * Apps should use ViewDragHelper.initAndGet() to get a new instance. This will
     ...
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
     * @return The topmost child view under (x, y) or null if common_none found.
     */
