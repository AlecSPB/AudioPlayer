...
/**
 * Created by itcayman on 2017/10/29.
 */
...
public class MetroLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (null != attrs) {
            ...
            mWidth = a.getDimensionPixelSize(R.styleable.MetroLoadingView_indicator_width, dp2px(40));
            mHeight = a.getDimensionPixelSize(R.styleable.MetroLoadingView_indicator_height, dp2px(2));
            mRadius = a.getDimensionPixelSize(R.styleable.MetroLoadingView_indicator_radius, dp2px(4));
            mNumber = a.getInt(R.styleable.MetroLoadingView_number, 1);
            ...
            mDelay = a.getInt(R.styleable.MetroLoadingView_interval_in_mills, 20);
