...
public class DaoSession extends AbstractDaoSession {
    ...
    public void clear() {
        artistEntityDaoConfig.clearIdentityScope();
        collectSongDaoConfig.clearIdentityScope();
        songEntityDaoConfig.clearIdentityScope();
        commonEntityDaoConfig.clearIdentityScope();
        songInfoEntityDaoConfig.clearIdentityScope();
    }
